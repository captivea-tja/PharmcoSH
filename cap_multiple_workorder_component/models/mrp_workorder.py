...
class MrpProductionWorkcenterLine(models.Model):
    ...
    def _change_quality_check(self, **params):
        ...
        if 'increment' in params:
            ...
            from_last_step = not self.current_quality_check_id and not self.current_quality_check_id_2 and not self.current_quality_check_id_3 and not self.current_quality_check_id_4
            ...
            if from_last_step and params.get('increment') < 0:
                if not even:
                    position_3 = position_3 + params.get('increment')
            else:
                position_3 = position_3 + increment
            ...
            if from_last_step and params.get('increment') < 0:
                if not even:
                    position_4 = position_4 + params.get('increment')
            else:
                position_4 = position_4 + increment
            ...
            position_3 = position + 1
            if position_3 in range(0, order_check_len):
                check_id_3 = ordered_check_ids[position + 1]
            else: 
                check_id_3 = False

            position_4 = position + 1
            if position_4 in range(0, order_check_len):
                check_id_4 = ordered_check_ids[position + 1]
            else: 
                check_id_4 = False
